...
const LogIn: React.FC<{ onBack: () => void; onSwitchToSignup: () => void }> = ({ onBack, onSwitchToSignup }) => (
    ...
    <div className="max-w-md w-full space-y-8 bg-[#1A2333] p-8 sm:p-10 rounded-2xl border border-white/5 shadow-2xl">
      <div>
        ...
        <p className="mt-2 text-center text-sm text-gray-400">
          Don't have an account? <button onClick={onSwitchToSignup} className="text-[#60A5FA] hover:underline">Sign up</button>
        </p>
      </div>
